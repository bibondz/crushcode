...
pub const palette_command_data = [_]PaletteItem{
    ...
    .{ .category = .command, .label = "/theme catppuccin", .description = "Switch to Catppuccin Mocha theme", .shortcut = "", .icon = "💡", .action = "/theme catppuccin" },
    .{ .category = .command, .label = "/theme nord", .description = "Switch to Nord theme", .shortcut = "", .icon = "💡", .action = "/theme nord" },
    .{ .category = .command, .label = "/theme dracula", .description = "Switch to Dracula theme", .shortcut = "", .icon = "💡", .action = "/theme dracula" },
