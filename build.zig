...
pub fn build(b: *std.Build) !void {
    ...
    addImports(main_mod, &.{
        ...
        imp("auto_gen", auto_gen_mod),
        imp("feedback", feedback_mod),
    });
